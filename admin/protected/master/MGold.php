...
/**
 * This is the model class for table "gold_index".
 *
 * The followings are the available columns in table 'gold_index':
 * @property integer $goldindexid
 * @property string $buy_price
 * @property string $sell_price
 * @property string $date
 */
class MGold extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Gold the static model class
	 */
